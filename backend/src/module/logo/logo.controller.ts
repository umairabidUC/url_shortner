...
export class LogoController {
  ...
  @Delete()
  deleteLogo(@Body("logo_path") logo_path: string, @Body("user_id") user_id: string, @Body("logo_id") logo_id: number) {
    return this.logoService.deleteLogo({ logo_path, user_id, logo_id })
  }
}
