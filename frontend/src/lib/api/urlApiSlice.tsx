...
export const urlsAPI = createApi({
    ...
    reducerPath: "urlsAPI",
    tagTypes: ["Urls", "PreGen", "Tags", "Logo"],
...
export const { useGetUserUrlsQuery, useAddNewUrlMutation, useDeleteUrlMutation, useGenerateUrlsMutation, useGetPreGenQuery, useUpdatePreGenUrlMutation, useCreateTagMutation, useGetTagsQuery, useAddLogoMutation, useGetLogosQuery } = urlsAPI;